...
export type SkillManagerProvenanceRow = { label: string; value: string };
        ...
        >
          <div className="flex items-start justify-between gap-3 border-b border-[var(--glass-border-subtle)] px-4 py-3">
            <div className="min-w-0">
              <div
                id="skill-assignment-manager-title"
          ...
          <div className="max-h-[calc(88vh-62px)] overflow-auto px-4 py-4">
            ...
            {error ? (
              <div
                className="mt-3 rounded-lg border border-rose-500/30 bg-rose-500/10 px-3 py-2 text-xs text-rose-600 dark:text-rose-400"
                role="alert"
              >
                {error}
              </div>
              ...
              <div className={settingsWorkspacePanelClass(isDark)}>
                  ...
                  {actors
                    ...
                    .map((actor) => {
                      ...
                      return (
                        <div
                          key={actorId}
                          className={`flex items-start gap-2 ${settingsWorkspaceSoftPanelClass(isDark)}`}
                        >
                ...
                <div className="mt-3 flex justify-end">
                  <button
                    ...
                    disabled={busyKey === `manage-use:${capabilityId}`}
                    onClick={onSaveActorAssignments}
                  >
            ...
            {editable ? (
              <div className={`mt-4 ${settingsWorkspacePanelClass(isDark)}`}>
                <div className="text-sm font-medium text-[var(--color-text-primary)]">
                  {labels.otherActionsTitle}
                </div>
                <div className="mt-1 text-xs text-[var(--color-text-muted)]">
                  {labels.otherActionsHint}
                </div>
