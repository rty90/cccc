...
import { getReplyQuoteBy, getReplyQuoteText, getStableMessageKey } from "../virtualMessageListHelpers";
        ...
        {virtualItems.map((virtualRow) => {
          ...
          return (
            <VirtualMessageRow
              ...
              resolvedReplyQuoteBy={getReplyQuoteBy(message, messageSenderById)}
