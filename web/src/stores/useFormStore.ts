...
interface FormState {
  ...
  setEditActorNotes: (v: string) => void;
  ...
  setNewActorNotes: (v: string) => void;
...
export const useFormStore = create<FormState>((set) => ({
  ...
  setEditActorNotes: (v) => set({ editActorNotes: v }),
  ...
  setNewActorNotes: (v) => set({ newActorNotes: v }),
